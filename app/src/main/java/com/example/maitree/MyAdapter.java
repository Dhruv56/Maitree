    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (i == 1) {
                ...
                v.getContext().startActivity(new Intent(v.getContext(), AboutMaitree.class));
            } else if (i == 7) {
                v.getContext().startActivity(new Intent(v.getContext(), DeveloperActivity.class));
            } else if (i == 8) {
                v.getContext().startActivity(new Intent(v.getContext(), Directory.class));
            }else if (i == 9) {
                v.getContext().startActivity(new Intent(v.getContext(), PDF.class));
            }
            else if (i == 10) {
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setType("text/plain");
                intent.putExtra(Intent.EXTRA_SUBJECT, "Maitree");
                String s = "\nTry this new Tourism Application\n\n";
                s = s + "my link here \n\n";
